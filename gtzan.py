...
lr = theanoxla.schedules.PiecewiseConstant(args.LR, {70: args.LR/3,
                                                      100: args.LR/6})
...
#    REP.append(np.concatenate(r))
    ...
    # save the file
    np.savez('save_GTZAN_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}.npz'.format(args.BS, args.option, args.J, args.Q, args.L,
